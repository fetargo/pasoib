...
class Ui_AuthWindow(object):
    def setupUi(self, AuthWindow):
        ...
        self.comboLevel = QtWidgets.QComboBox(self.centralwidget)
        self.comboLevel.setObjectName("comboLevel")
        self.gridLayout.addWidget(self.comboLevel, 6, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.labelPass, 3, 0, 1, 1)
        self.labelLevel = QtWidgets.QLabel(self.centralwidget)
        self.labelLevel.setObjectName("labelLevel")
        self.gridLayout.addWidget(self.labelLevel, 5, 0, 1, 1)
    ...
    def retranslateUi(self, AuthWindow):
        ...
        self.labelLevel.setText(_translate("AuthWindow", "Session level"))
        self.btnAuth.setText(_translate("AuthWindow", "Sing in"))
